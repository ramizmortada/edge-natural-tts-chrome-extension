...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-black/75 backdrop-blur-sm duration-150 animate-in fade-in-0",
        className
      )}
      {...props}
    />
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn(
        "text-base font-semibold leading-none flex items-center gap-2.5",
        className
      )}
      {...props}
    />
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Close
      ...
      className={cn("border-slate-700 text-slate-300 hover:text-white hover:bg-slate-800", className)}
